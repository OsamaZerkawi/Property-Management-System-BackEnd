...
export function GetRelatedTouristicSwaggerDoc() {
  return applyDecorators(
    ...
    ApiOkResponse({
      ...
      avg_rate: { type: 'number', example: 4.5, description: 'متوسط تقييم المستخدمين للعقار (0–5)' },
      is_favorite: { type: 'boolean', example: true, description: 'هل العقار مفضل لدى المستخدم' },
    },
        },
      },
    }),
