    ...
    for (let i = 0; i < 5; i++) {
      ...
      for (let j = 0; j < 10; j++) {
        ...
        const property = this.propertyRepo.create({
          ...
          bedroom_count: faker.number.int({ min: 1, max: 3 }),
          kitchen_count: faker.number.int({ min: 1, max: 3 }),
        ...
        const residential = this.residentialRepo.create({
          ...
          ownership_type: faker.helpers.arrayElement(
