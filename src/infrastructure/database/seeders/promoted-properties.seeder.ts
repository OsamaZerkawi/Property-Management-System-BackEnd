...
export class PromotedPropertySeeder {
  constructor(
    ...
    private promotedRepo: Repository<PromotedProperty>,
    @InjectRepository(Property) private propertyRepo: Repository<Property>,
    @InjectRepository(OnlineInvoice)
    private invoiceRepo: Repository<OnlineInvoice>,
